// pages/right-to-be-forgotten.js
...
export default function RightToBeForgottenPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setMessage('Your erasure request has been submitted. If your request is valid, your data will be permanently deleted within 30 days.');
      setSubmitting(false);
    }, 1500);
  };
      ...
      <main className="flex-grow py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-primary-dark">Right to be Forgotten</h1>
            <p className="mt-4 text-lg text-medium-gray max-w-2xl mx-auto">
              You can use this form to request the permanent erasure of your personal data from our systems. Please note that this action is irreversible.
            </p>
          </div>
          ...
          <div className="mt-12 bg-white p-8 md:p-12 rounded-2xl shadow-xl">
            {message ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* The form fields are identical to the access request form */}
                ...
                <div>
                  <label htmlFor="requestDetails" className="block text-sm font-medium text-gray-700">Reason for Erasure Request</label>
                ...
                <div className="text-right">
                  <button type="submit" disabled={submitting} className="inline-flex items-center gap-2 px-8 py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-all duration-300 disabled:bg-gray-400">
                    <FiTrash2 />
                    {submitting ? 'Processing...' : 'Request Permanent Deletion'}
                  </button>
                </div>
              </form>
            )}
